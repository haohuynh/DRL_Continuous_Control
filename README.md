...
The Udacity implementation of DDPG can be found at ddpg_agent.py and model.py. The Agent & Neural Net Model are slightly modified to increase the speed of convergence.

Please see the Continuous Control notebook for how the DDPG Agent can be utilized for 20 identical agents.
